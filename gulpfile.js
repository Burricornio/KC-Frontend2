...
gulp.task("sass", function(){
    gulp.src("src/scss/styles.scss") // cargamos el archivo style.scss
...
// Tarea para optimizare y crear las imágenes responsive
gulp.task("img", function() {
    gulp.src("src/img-responsive/*")
        ...
        .pipe(imagemin()) // Optimizamos el peso de la imágenes
